...
<section class="py-16 bg-teal-400">
	<div class="container mx-auto px-4">
		<h2 class="text-3xl font-bold uppercase text-center text-teal-50 mb-10">
			Що таке матриця долі? Які питання допомогає вирішити?
		</h2>
		<div class="flex flex-col items-center gap-5 px-14">
			<div class="mb-3">
				<p class="text-center text-stone-50">
			...
			<div class="mb-3">
				<p class="text-center text-stone-50 italic">
			...
			<div class="flex flex-col items-center">
				<a href="#" class="arrow-link">
					<svg
						...
						stroke-width="1.5"
						stroke="currentColor"
						class="w-16 h-16 text-teal-300 animate-bounce arrow"
					>
						<path
