...
<section class="py-16 bg-[#1A5572]">
	<div class="container mx-auto px-4">
		<div class="max-w-3xl mx-auto">
			<div class="flex justify-between place-items-center gap-10">
				<div>
					<p class="text-slate-50 text-xl">Приєднуйся до мене у соціальних мережах та отримай відео-урок + методичку у подарунок</p>
				</div>
				<div>
