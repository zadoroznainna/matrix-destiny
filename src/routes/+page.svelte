...
<svelte:head>
	<title>Інна Задорожна – Експертка з Матриці Долі | Аналіз та Консультації</title>
	<meta
		name="description"
		content="Інна Задорожна – експертка з аналізу Матриці Долі. Допоможу розкрити ваші таланти, знайти покликання, покращити стосунки та фінанси. Отримайте персональну консультацію та змініть своє життя на краще!"
	/>
</svelte:head>
