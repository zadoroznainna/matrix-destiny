<script>
	...
	const informationData = ["Ваша дата народження", "Ваше ім'я", "Запит з яким ви йдете на консультацію"];
</script>

<section class="py-16">
	<div class="container mx-auto px-4">
		<h2 class="text-slate-700 text-3xl font-bold text-center uppercase mb-8 pt-10">Як проходить консультація</h2>
		<div class="flex flex-col lg:flex-row gap-10">
					...
					{#each stepsData as step, index (step)}
						<li class="flex justify-start items-center gap-4">
							...
							<div class="flex-grow px-3">
								<h4 class="text-slate-700 text-xl font-bold mb-4">{step.title}</h4>
			...
			<div class="basis-1/2">
				<div class="flex flex-col">
					<div class="mb-8">
						<h3 class="text-slate-700 text-xl font-bold mb-3">Що мені потрібно від вас, щоб зробити розбір ?</h3>
						<ul class="space-y-2">
					...
					<div class="mb-4">
						<img src={photoSteps} class="rounded-3xl object-cover" alt="Steps work" />
					</div>
				</div>
			</div>
		</div>
